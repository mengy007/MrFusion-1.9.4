...
public class ClientProxy extends CommonProxy {
    ...
    public void init() {
         ...
         * Blocks
         */
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(GameRegistry.findItem(Reference.MOD_ID, "mrfusion"), DEFAULT_ITEM_SUBTYPE, new ModelResourceLocation("mrfusion:mrfusion", "inventory"));
    }
}
